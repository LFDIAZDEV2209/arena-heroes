...
class AppDlc extends HTMLElement {
    constructor() {
        super();
        this.render();
    }
            ...
            <div class="container  overflow-auto h-full justify-end sm:pl-30">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 justify-items-center p-10">
                    ${charactersDlc.map((character, idx) => {
                        return `
                        <div class="w-70 max-w-sm border-2 border-gray-300 shadow-xl -skew-x-12 [perspective:1000px] bg-gray-300 hover:scale-105 ">
                            <div class="relative w-full h-[350px] transition-transform duration-500  card-inner-${idx}" style="transform-style: preserve-3d;">
                                ...
                                <div class="absolute inset-0 backface-hidden shadow-xl flex items-center justify-center rotate-y-180 z-20 overflow-hidden">
                                    <div class="w-full h-full flex flex-col items-center justify-center py-15">
