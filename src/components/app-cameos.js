        ...
        <div class="container mx-auto px-16 py-20">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
                    ${characterCameos.map((character, idx) => {
                        return `
                        <div class="w-70 max-w-sm border-2 border-gray-300 shadow-xl -skew-x-12 [perspective:1000px]">
                            <div class="relative w-full h-[400px] transition-transform duration-500 card-inner-${idx}" style="transform-style: preserve-3d;">
                                ...
                                <div class="absolute inset-0 backface-hidden flex flex-col items-center py-10 z-10">
                                    ...
                                    <button class="bg-yellow-300 text-black font-semibold rounded px-8 py-1 mt-4 mx-auto block btn-view" data-idx="${idx}">view details</button>
                                </div>
                                <!-- Cara trasera limpia -->
