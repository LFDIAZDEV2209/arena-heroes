    ...
    this.innerHTML = `
      ...
      <div class="w-screen h-screen flex flex-col items-center justify-center">
        <div class="flex justify-center items-center flex-row w-4/5 mx-auto m-8">
          <!-- Ganador -->
          <div id="player1-card" class="winner-card group relative w-[350px] h-[450px] flex-col flex items-center border-10 border-amber-300 overflow-hidden skew-y-[-3deg] bg-gray-700 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer">
